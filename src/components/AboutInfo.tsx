export default function AboutInfo() {
    return (
        <div className="about-container">
            ...
            <p>
                Here, puzzles challenge your analytical skills, interactive tutorials
                guide your learning step-by-step, and an in-built IDE becomes your
                playground for experimentation. We bridge the gap between theory and
                practice, empowering you to not just understand algorithms, but to wield
                them as tools for building impactful software.
            </p>
            <p>
